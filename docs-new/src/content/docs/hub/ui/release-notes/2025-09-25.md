---
title: "2.0.0 (2025-09-25)"
description: "Giskard Hub 2.0.0 release notes - upgraded LLM vulnerability scanner with autonomous red teaming agents, multi-turn attack simulation, and comprehensive OWASP coverage."
sidebar:
  order: 9
---
...
Versions released since 2.0.0 Hub UI release and before 2.0.1 Hub UI release.

See [Hub SDK Release Notes](/hub/sdk/release-notes) for SDK changes released with this version.

:::tip
See the [Hub SDK 2025-10-30 release notes](/hub/sdk/release-notes/2025-10-30) section for the release notes on using the SDK for the LLM vulnerability scan feature.
:::
