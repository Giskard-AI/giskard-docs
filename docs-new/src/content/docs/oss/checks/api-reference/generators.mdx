...
- [Core API](/oss/checks/api-reference/core/) - Trace, Interaction, and InteractionSpec
- [Scenarios](/oss/checks/api-reference/scenarios/) - Building multi-step test workflows
- [Built-in Checks](/oss/checks/api-reference/builtin-checks/) - Validation checks for generated interactions
