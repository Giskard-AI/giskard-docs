...
#### `add_spec(spec: BaseInteractionSpec)`
...
- [Core API](/oss/checks/api-reference/core/) - Scenario, Trace, and Interaction details
- [Built-in Checks](/oss/checks/api-reference/builtin-checks/) - Checks to use in scenarios
- [Testing](/oss/checks/api-reference/testing/) - Test runners and utilities
