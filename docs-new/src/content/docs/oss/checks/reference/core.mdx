...
`TestCase` is an internal implementation detail. Users should always use the `Scenario()` class to create scenarios. The TestCase provides the execution engine that runs scenarios.
:::
