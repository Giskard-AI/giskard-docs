...
<TypeTable name="Check">
  <Property name="name" type="str | None" defaultValue="None">Optional check name for reporting.</Property>
  <Property name="description" type="str | None" defaultValue="None">Human-readable description of what the check validates.</Property>
</TypeTable>
...
<TypeTable name="CheckResult">
  <Property name="status" type="CheckStatus">Outcome status (PASS, FAIL, ERROR, SKIP).</Property>
  <Property name="message" type="str | None">Optional short message to surface to users.</Property>
  <Property name="metrics" type="list[Metric]">List of auxiliary metrics captured by the check.</Property>
  <Property name="details" type="dict[str, Any]">Arbitrary structured payload with additional context.</Property>
</TypeTable>
...
result = CheckResult.success(message="All validations passed", details={"score": 0.95})
result = CheckResult.failure(message="Score below threshold", details={"score": 0.65})
...
<TypeTable name="CheckResult properties">
  <Property name="passed" type="bool">True if status is PASS.</Property>
  <Property name="failed" type="bool">True if status is FAIL.</Property>
  <Property name="errored" type="bool">True if status is ERROR.</Property>
  <Property name="skipped" type="bool">True if status is SKIP.</Property>
</TypeTable>
...
<TypeTable name="Interaction">
  <Property name="inputs" type="InputType">Input values for this interaction (e.g. user message, API request).</Property>
  <Property name="outputs" type="OutputType">Output values produced in response (e.g. assistant reply, API response).</Property>
  <Property name="metadata" type="dict[str, Any]">Optional metadata (timing, tool calls, intermediate states, etc.).</Property>
</TypeTable>
...
<TypeTable name="Trace">
  <Property name="interactions" type="list[Interaction]">Ordered list of all interactions. Most recent at `[-1]`.</Property>
  <Property name="last" type="Interaction | None">Computed property returning the last interaction, or None if empty.</Property>
</TypeTable>
...
# Static values
scenario = Scenario("static").interact(inputs="test input", outputs="test output")
...
result = await (
    ...
    .check(FnCheck(fn=lambda trace: "Hi" in trace.last.outputs, name="greeting"))
...
<MethodCard name="resolve()" returnType="Any | NoMatch">
  <Property name="trace" type="Trace" required>The trace to extract from.</Property>
  <Property name="path" type="str" required>JSONPath expression.</Property>
</MethodCard>
