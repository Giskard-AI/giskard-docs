...
Use `WithSpy` when: debugging complex interaction generation logic, understanding the flow of multi-turn interactions, tracking how trace context affects subsequent interactions, or investigating unexpected behavior in scenarios.
...
- [Tutorials](/oss/checks/tutorials/) - Step-by-step tutorials for core testing patterns
- [How-to Guides](/oss/checks/how-to/) - Task-oriented guides for specific use cases
