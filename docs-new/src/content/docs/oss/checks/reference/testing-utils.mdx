...
test_case = TestCase(
    ...
    checks=[
        ...
        Equals(expected_value="I'm doing well!", key="trace.interactions[1].outputs"),
    ],
)
...
async def test_greeting_response():
    ...
    test_case = TestCase(
        ...
        checks=[
            ...
            from_fn(
                lambda t: "help" in t.last.outputs.lower(), name="offers_help"
            ),
        ],
    )
...
async def test_error_handling():
    ...
    test_case = TestCase(
        ...
        trace=trace,
        checks=[
            Equals(expected_value=True, key="trace.last.metadata.error_handled"),
            from_fn(
...
async def test_greeting_variations(greeting_input, expected_output):
    ...
    test_case = TestCase(
        ...
        trace=trace,
        checks=[Equals(expected_value=expected_output, key="trace.last.outputs")],
    )
