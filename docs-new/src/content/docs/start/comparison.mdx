...
description: "Compare Giskard Hub (enterprise) vs Giskard Open Source to choose the right LLM agent testing solution for your team size, security needs, and collaboration requirements."
sidebar:
  order: 2
---
...
| :--- | :---: | :---: |
| **Core Testing** | | |
| Security vulnerability detection | Basic coverage | [State-of-the-art detection](/hub/ui/scan) |
| Business failure detection | Basic coverage | [State-of-the-art detection](/hub/ui/datasets/knowledge-base) |
...
| Custom tests | Full support | [Full support](/hub/ui/annotate/overview) |
| Local evaluations | Full support | [Full support](/hub/ui/evaluations) |
| **Team Collaboration** | | |
...
- **Want to get started with Open Source?** Start with [Giskard Open Source](/oss)
