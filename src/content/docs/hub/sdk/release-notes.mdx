...
This patch release builds on the first v3 SDK release introduced in [`3.0.0`](/hub/sdk/release-notes#300-2026-04-01), with API consistency fixes, helper compatibility improvements, and documentation updates.
