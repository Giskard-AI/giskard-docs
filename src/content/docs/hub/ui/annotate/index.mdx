...
description: "Review and refine scenarios with domain expertise. Use collaborative annotation workflows to improve test quality and ensure comprehensive evaluation coverage."
sidebar:
  order: 1
  label: Overview
---
...
Each scenario is composed of a **conversation** and its associated **evaluation parameters** (e.g., an expected answer, rules that the agent must respect, etc.).
...
3. **Modify scenarios** - Product owner workflow for refining scenarios and validation rules
...
- **Modify scenarios** - Follow the product owner workflow to refine scenarios and checks [modify scenarios](/hub/ui/annotate/modify-test-cases)
...
1. **Run an evaluation** or **review scan results** to identify scenarios that need attention
