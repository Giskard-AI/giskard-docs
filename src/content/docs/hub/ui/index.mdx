---
title: "AI Agent Testing and Scanning Platform"
head:
  - tag: title
    content: "AI Agent Testing and Scanning Platform | Giskard"
...
![Giskard Hub workflow: scan vulnerabilities, evaluate datasets, then review results and automate](@assets/images/hub/hub-workflow.png)
...
![Giskard Hub project dashboard showing stats, scheduled evaluations, and scans](@assets/images/hub/dashboard.png)
...
![Agent configuration form with API endpoint and header settings](@assets/images/hub/setup-agent-detail.png)
...
![Knowledge base import form with name and file upload fields](@assets/images/hub/import-kb-detail.png)
