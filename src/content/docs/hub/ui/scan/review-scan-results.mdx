...
![Scan results showing overall security grade and category breakdown](@assets/images/hub/scan/scan-results.png)

## Explore attack details

Scroll to any vulnerability category to see the specific attacks that were tested:

![Probe listing showing attack categories and success rates](@assets/images/hub/scan/probe-listing.png)
...
<Tabs>
  <TabItem label="Chat agent">
    ...
    ![Attack detail for a chat agent showing the prompt, response, and vulnerability](@assets/images/hub/scan/attempt-successful.png)
  ...
  <TabItem label="Structured agent">
    ...
    ![Attack detail for a structured agent showing its JSON input and output](@assets/images/hub/scan/structured-scan-attack.png)
