---
title: "Setup projects and agents"
description: "Create projects, connect Chat or Structured agents, and import knowledge bases in Giskard Hub so you can scan, test, and evaluate agentic applications."
sidebar:
  order: 1
  label: Overview
---
