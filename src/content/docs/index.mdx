...
- Behavioral tests written as scenarios and checks that pass or fail under pytest.
- Automated detection of security vulnerabilities using `vulnerability_scan`.
