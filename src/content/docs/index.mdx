---
title: "Giskard: AI Agent Evaluation and Red Teaming Platform"
head:
  - tag: title
    content: "Giskard: AI Agent Evaluation and Red Teaming"
...
The scan is not installed by default: add the `scan` extra (`pip install "giskard[scan]"`). Scan results are not a safety or compliance guarantee.
