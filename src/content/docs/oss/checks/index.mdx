...
New here? Work through these in order. Each one builds on the previous.

<Steps>

1. [Install & Configure](/oss/checks/installation) (~5 min): get the library installed and an LLM provider configured. If you'd rather see the whole thing working first, the [Quickstart](/oss/checks/quickstart) runs one end-to-end example.
