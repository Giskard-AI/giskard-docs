...
Looking for tests you don't have to write? [Giskard Scan](/oss/solutions) generates an adversarial suite from a plain-language description of your agent, and returns it as an ordinary `Suite` you run with everything below.
