...
Install the [Scenario Generator agent skill](/oss/agent-skills) and let your coding agent (Claude Code, Cursor, and more) design red-team suites directly from a plain-English description of your agent.
:::
