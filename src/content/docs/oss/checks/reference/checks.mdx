...
### `LesserThan` / `LesserThanEquals` (deprecated)

Deprecated aliases for `LessThan` and `LessThanEquals`. They remain importable and
behave identically; use the correctly-spelled names in new code.
