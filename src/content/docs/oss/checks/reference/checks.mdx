...
Check that the extracted value equals an expected value.
...
Check that the extracted value does **not** equal an expected value.
...
Check that the extracted value is strictly greater than the expected value.
...
Check that the extracted value is greater than or equal to the expected value.
...
Check that the extracted value is strictly less than the expected value.
...
Check that the extracted value is less than or equal to the expected value.
