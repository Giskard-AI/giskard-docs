...
<Property
  name="keyword_key"
  type="JSONPathStr | MISSING"
  defaultValue="MISSING"
>
  JSONPath to extract the keyword from the trace.
</Property>
<Property name="text" type="str | MISSING" defaultValue="MISSING">
  Static text to search in. Left at `MISSING`, the check reads `target_key`.
</Property>
...
<Property
  ...
  type='Literal["NFC", "NFD", "NFKC", "NFKD"] | None'
  defaultValue='"NFKC"'
>
...
<Property name="text" type="str | MISSING" defaultValue="MISSING">
  Static text to match against. Left at `MISSING`, the check reads `target_key`.
</Property>
<Property name="target_key" type="str" defaultValue='"trace.last.outputs"'>
...
<TypeTable name="Equals">
  ...
  <Property
    name="match"
    type='Literal["any", "all", "none"] | MISSING'
    defaultValue="MISSING"
  >
    How to apply the comparison when the resolved value is a list, set, or
    tuple. Omit it to compare the resolved value directly. `"any"` passes when
    at least one item matches, `"all"` when every item does, `"none"` when no
    item does.
  </Property>
</TypeTable>
...
<Property name="answer" type="str | MISSING" defaultValue="MISSING">
  The answer text to evaluate (static). Left at `MISSING`, the check reads
  `target_key`.
</Property>
<Property name="target_key" type="str" defaultValue='"trace.last.outputs"'>
...
<Property
  name="context"
  type="str | list[str] | MISSING"
  defaultValue="MISSING"
>
  Context document(s) that should support the answer (static). Left at
  `MISSING`, the check reads `context_key`.
</Property>
<Property
  name="context_key"
  type="str"
...
<Property
  ...
  defaultValue="MISSING"
>
  Context document(s) the answer is checked against (static). Left at `MISSING`,
  the check reads `context_key`.
</Property>
<Property
  name="context_key"
  type="str"
...
<Property name="question" type="str | MISSING" defaultValue="MISSING">
  Question to evaluate against. Left at `MISSING`, the check reads
  `question_key`.
</Property>
...
<Property
  name="categories"
  type="list[ToxicityCategory]"
  defaultValue='["hate_speech", "harassment", "threats", "self_harm", "sexual_content", "violence"]'
>
...
<Property name="reference_text" type="str | MISSING" defaultValue="MISSING">
  Reference text to compare against (static). Left at `MISSING`, the check reads
  `reference_text_key`.
</Property>
<Property
...
<Property
  ...
  defaultValue="None"
>
  Embedding model used to compute similarity scores. `None` falls back to the
  global default.
</Property>
...
<Property
  ...
  defaultValue='"flesch_reading_ease"'
>
