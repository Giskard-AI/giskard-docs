...
<!-- pyright-skip: This custom-check example omits the empty-trace guard to focus on the check contract. -->
```python
...
<!-- pyright-skip: This scenario fragment assumes every step produces an interaction. -->
```python
