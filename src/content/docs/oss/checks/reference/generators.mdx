...
<MethodCard name=".get_prompt()" returnType="ChatMessage | MessageTemplate | TemplateReference">
  Return the prompt that drives generation. Subclasses **must** override this; the base raises `NotImplementedError`.
</MethodCard>
