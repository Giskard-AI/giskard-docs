---
title: Scenarios
description: "Multi-step workflow testing in giskard.checks: Scenario builders, runners, and how chained interactions build the trace that checks then read."
sidebar:
  order: 4
---
