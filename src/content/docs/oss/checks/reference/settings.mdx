---
title: Settings
description: "Configure Giskard Checks through GiskardChecksSettings: the default LLM generator, the embedding model, and the environment variables behind them."
sidebar:
  order: 8
---
