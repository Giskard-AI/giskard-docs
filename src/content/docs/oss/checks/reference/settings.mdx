...
<MethodCard name="set_default_generator()" returnType="None">
  ...
  <Property name="generator" type="BaseGenerator | str" required>A generator instance, or a model identifier string (e.g. `"openai/gpt-4o-mini"`) wrapped in `Generator` automatically. Used by LLM checks that do not receive one explicitly.</Property>
</MethodCard>
