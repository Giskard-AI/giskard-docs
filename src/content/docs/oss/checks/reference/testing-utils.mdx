...
<!-- pyright-skip: This focused predicate assumes the test trace has an interaction. -->
```python
import pytest
...
<!-- pyright-skip: This integration fragment requires the reader's myapp module. -->
```python
...
<!-- pyright-skip: This continuation example depends on the recorded interaction from the prior block. -->
```python
import asyncio
