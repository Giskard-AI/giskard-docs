...
<CardGrid>
  ...
  />
  <LinkCard
    title="Red-Team, Then Regression-Test"
    description="Capstone: scan a weak agent for vulnerabilities, save the generated suite, fix the agent, and freeze the finding into a permanent check"
    href="/oss/checks/tutorials/redteam-to-regression"
  />
</CardGrid>
...
- Turn a red-team finding into a permanent regression check
