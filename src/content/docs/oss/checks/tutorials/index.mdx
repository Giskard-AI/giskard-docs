...
<CardGrid>
  ...
  <LinkCard
    title="Gate your PRs"
    description="Run an agent check suite in GitHub Actions with thresholds, JUnit reporting, and a copy-pasteable workflow"
    href="/oss/checks/tutorials/gate-your-prs"
  />
</CardGrid>
...
- Gate pull requests on suite results in GitHub Actions
