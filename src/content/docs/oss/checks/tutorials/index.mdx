...
<CardGrid>
  ...
  />
  <LinkCard
    title="Simulate a Difficult User"
    description="Run a support bot against frustrated, scope-creeping, and prompt-injecting simulated users"
    href="/oss/checks/tutorials/simulate-difficult-users"
  />
</CardGrid>
