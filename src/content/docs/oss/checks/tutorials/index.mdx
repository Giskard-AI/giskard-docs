...
<CardGrid>
  ...
  />
  <LinkCard
    title="Test a LangGraph Agent"
    description="Test an agent's final answer, the tools it decided to call, and the arguments those tools received"
    href="/oss/checks/tutorials/test-langgraph-agents"
  />
</CardGrid>
...
- Test an agent's tool-call trajectory, not just its final answer
