...
description: "Pytest-native, async-first, framework-agnostic behavioral testing of LLM applications and AI agents — scenarios and checks, not just metric scores, fully local."
---
...
The third version of the library is available as a pre-release (Beta). This version is a major rewrite and includes new features such as [Checks](/oss/checks) and a redesigned [Scan](/oss/solutions/scan-vulnerabilities).
...
- **Scan**: Automatically probe your app for vulnerabilities with [Scan](/oss/solutions/scan-vulnerabilities)
