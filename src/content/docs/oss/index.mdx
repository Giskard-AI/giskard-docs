...
Install the library and point it at your LLM provider — some checks are graded by an LLM judge:
...
- **Agent Skills**: Install [Giskard Agent Skills](/start/agent-skills) to give Claude Code, Codex, Cursor, and other coding agents drop-in workflows for Giskard tasks
