...
| ------------------ | ----------------------------------------------------------------------------------------------------- | -------------------- | ---------------------------------------------------------------------------------------------------------- |
| **LLM-driven**     | An LLM invents attacks tailored to _your_ `description`, so no two agents get the same test cases.    | `vulnerability_scan` | `AdversarialScenarioGenerator`, `GOATAttackScenarioGenerator`, `CrescendoAttackScenarioGenerator`          |
