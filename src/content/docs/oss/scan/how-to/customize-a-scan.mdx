...
description: "Customize a Giskard scan by selecting generators, controlling scenario budgets and concurrency, and adding your own test scenarios."
sidebar:
  order: 2
---
...
`generate_suite` builds a suite from the built-in scenarios. The [Scenario Generator skill](/start/agent-skills#scenario-generator-) turns your coding agent into a red-teamer instead. Describe your agent and the failure modes you care about, and the skill writes or extends a runnable suite with adversarial scenarios and layered checks tailored to your case:
