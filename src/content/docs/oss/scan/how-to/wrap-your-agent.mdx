...
All three examples wrap the same customer-support assistant for a retail bank, so the only thing that changes between them is how the turn history is carried.
