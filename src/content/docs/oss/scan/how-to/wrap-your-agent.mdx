...
### How textual test prompts become structured inputs

Scan generators create textual test prompts. Before calling your target, Giskard maps each prompt into the Pydantic input schema you declared. It places the prompt in the string field that most naturally carries a user message and fills other required fields with short, schema-valid placeholder values.
