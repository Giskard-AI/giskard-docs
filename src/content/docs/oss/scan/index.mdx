...
<CardGrid>
  ...
  <LinkCard
    ...
    href="/oss/scan/scan-vulnerabilities"
  />
  <LinkCard
  ...
  <LinkCard
    ...
    href="/oss/scan/reference/scan-api#quality_scan"
  />
  <LinkCard
