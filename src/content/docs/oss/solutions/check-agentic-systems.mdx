...
description: "Write your first Giskard check against an agent: wrap it, assert a rule in plain English, collect scenarios into a suite, and export JUnit XML for CI."
sidebar:
  order: 2
---
