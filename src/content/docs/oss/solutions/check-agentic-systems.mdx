...
description: "Write your first Giskard check against an agent: wrap the agent, assert a rule in plain English, collect scenarios into a suite, and export JUnit XML for CI."
sidebar:
  order: 2
---
