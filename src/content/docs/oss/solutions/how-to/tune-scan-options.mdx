...
The keyword arguments below control what a scan costs, how repeatable it is, and how the report is grouped. Read [How the Scan Works](/oss/solutions/explanation/how-scan-works) first if you have not run a scan yet.
...
# in /oss/solutions/how-to/wrap-your-agent.
