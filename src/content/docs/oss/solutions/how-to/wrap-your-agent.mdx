...
Before you start, run `pip install --pre "giskard[scan,openai]"`, which brings in the `openai` client and Pydantic used below. See [Install & Configure](/oss/solutions/installation) for the provider setup.
