...
<CardGrid>
  ...
  />
  <LinkCard
    title="How-to: Tune a scan run"
    description="Cap the scenario budget, fix the seed, throttle concurrency, and regroup the report."
  ...
  <LinkCard
    ...
    description="Generators, target modes, threat types, and why the LLM judge is sometimes wrong."
