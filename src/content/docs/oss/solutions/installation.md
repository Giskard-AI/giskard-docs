...
```
Follow the instructions from https://docs.giskard.ai/oss/solutions/installation.md and install Giskard Scan with the giskard meta package in my project.
```
...
Continue with [Scan Vulnerabilities](/oss/solutions/scan-vulnerabilities) to point the scan at your own agent.
