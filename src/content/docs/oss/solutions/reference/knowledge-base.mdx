...
kb = KnowledgeBase(
    documents=(
        Document(
            content="Lavender needs full sun and gritty, free-draining soil.",
            tags=["planting"],
        ),
        Document(
            content="Foxglove is toxic to humans and pets.",
            tags=["safety"],
        ),
    )
)
