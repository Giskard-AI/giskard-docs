...
description: "Red team your LLM agent with Giskard's open-source scan: generate hostile inputs from a description, run them, and read the failures it reports."
sidebar:
  order: 1
---
