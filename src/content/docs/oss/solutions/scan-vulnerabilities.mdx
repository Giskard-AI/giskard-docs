...
<!-- pyright-skip: This adapter requires the reader's LLM application. -->
```python
...
<!-- pyright-skip: This adapter requires the reader's LLM application and is an alternative to the basic adapter. -->
```python
...
<!-- pyright-skip: This adapter requires the reader's LLM application and is an alternative integration pattern. -->
```python
from pydantic import BaseModel
from giskard.checks import Trace
...
<!-- pyright-skip: This call uses the wrapped agent defined by the reader. -->
```python
...
<!-- pyright-skip: This continuation uses the scan result produced in the prior step. -->
```python
...
<!-- pyright-skip: This CI fragment uses the reader's wrapped agent. -->
```python
from pathlib import Path
...
<!-- pyright-skip: This continuation uses the reader's alternate agent implementation. -->
```python
...
<!-- pyright-skip: This focused suite still runs against the reader's wrapped agent. -->
```python
...
<!-- pyright-skip: This scan call uses the reader's wrapped agent. -->
```python
suite_result = await vulnerability_scan(
    target=my_agent,
    description="A Q&A agent that answers questions about our product.",
