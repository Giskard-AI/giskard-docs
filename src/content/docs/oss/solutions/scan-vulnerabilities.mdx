...
These cover high-impact attack surfaces today, and the library keeps adding more. See the [roadmap](#roadmap) for what is coming, the [vulnerability categories catalog](/hub/ui/scan/vulnerability-categories) for the complete list of categories, and [How the Scan Works](/oss/solutions/explanation/how-scan-works) for how generators, threat types, and target modes fit together.
