...
<CardGrid>
  <LinkCard
    ...
    description="The whole library: checks, scenarios, suites, and the judge."
    href="/oss/checks"
  />
  <LinkCard
    title="Multi-turn Scenarios"
    description="Test conversations rather than single messages."
    href="/oss/checks/tutorials/multi-turn"
  />
  <LinkCard
    title="Run Checks in pytest"
    description="Wire a suite into an existing test run."
