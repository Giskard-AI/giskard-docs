---
title: Agent Skills
description: "Drop-in agent skills for Claude Code, Cursor, and other coding agents that automate Giskard workflows, from Hub setup to test generation and Collibra export."
---
...
### Hub Agent Setup <Badge text="v1.0.0" variant="tip" />
