...
| Feature            | Giskard Open Source       | Giskard Hub                                       |
| :----------------- | :------------------------ | :------------------------------------------------ |
| Multi-user access  | ❌ Not natively supported | [✅ Shared team workspace](/hub/ui/access-rights) |
| Access control     | ❌ Not available          | [✅ Role-based access](/hub/ui/access-rights)     |
| Project management | ❌ Not natively supported | [✅ Centralized](/hub/ui/access-rights)           |
| Dataset sharing    | ❌ Not natively supported | [✅ Team-wide](/hub/ui/access-rights)             |
