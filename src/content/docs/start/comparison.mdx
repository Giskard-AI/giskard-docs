...
| Continuous red teaming           | [Run scans and replay suites in your CI](/oss/scan/how-to/scan-in-ci) | [✅ Managed continuous operation](/hub/ui/continuous-red-teaming) |
| Tool/function calling tests      | [✅ Code-first tool-call checks](/oss/checks/how-to/spy-on-calls)     | [✅ Managed review workflows](/hub/ui/annotate/overview)          |
...
| **Team Collaboration**           |                                                                       |                                                                   |
| Multi-user access                | Collaborate through Git and CI                                        | [✅ Shared team workspace](/hub/ui/access-rights)                 |
| Access control                   | ❌ Not available                                                      | [✅ Role-based access](/hub/ui/access-rights)                     |
| Project management               | Versioned in your repository                                          | [✅ Centralized](/hub/ui/access-rights)                           |
| Dataset sharing                  | Share through version-controlled files                                | [✅ Team-wide](/hub/ui/access-rights)                             |
| **Automation & Monitoring**      |                                                                       |                                                                   |
| Scheduled evaluation runs        | Schedule with your CI runner                                          | [✅ Managed scheduling](/hub/ui/evaluations)                      |
...
| Performance tracking             | Retain user-managed CI results                                        | [✅ Managed historical data](/hub/ui/evaluations/compare)         |
| **Enterprise Security**          |                                                                       |                                                                   |
...
| Dedicated support & SLAs         | Community support                                                     | [✅ Enterprise-grade ↗](https://trust.giskard.ai/)                |
