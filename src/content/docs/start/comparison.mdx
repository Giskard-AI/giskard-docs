...
**Giskard Open Source** is a Python library you run locally from code: it covers the full testing loop for one developer or one CI pipeline. **Giskard Hub** is the hosted platform: broader red-teaming coverage, continuous testing of a deployed agent, and a web interface that non-engineers can use.
...
| :------------------------------- | :---------------------- | :------------------------------------------------------------ |
| **Core Testing**                 |                         |                                                               |
| Security vulnerability detection | [7 built-in generators](/oss/scan) | [55+ probes, continuously updated](/hub/ui/scan)              |
| Business failure detection       | [RAG quality scan](/oss/scan) | [Knowledge-base driven](/hub/ui/datasets/knowledge-base)      |
| Continuous red teaming           | ❌ Not available        | [✅ Full support](/hub/ui/continuous-red-teaming)             |
| Custom tests                     | [✅ Full support](/oss/checks) | [✅ Full support](/hub/ui/annotate/overview)                  |
| Tool/function calling assertions | [✅ `WithSpy`](/oss/checks/how-to/spy-on-calls) | [✅ Full support](/hub/ui/annotate/overview)                  |
| Local evaluations                | [✅ Full support](/oss/checks) | [✅ Full support](/hub/ui/evaluations)                        |
| **Team Collaboration**           |                         |                                                               |
...
- Around twenty built-in checks, LLM-as-judge, multi-turn scenarios, suites, and JUnit export
- Seven red-teaming generators mapped to the OWASP LLM Top 10, plus RAG quality evaluation
- Local control over your data and models: nothing leaves your machine except the calls you make to your own LLM provider
...
- **Want to get started with Open Source?** Start at [Giskard Library](/oss)
