...
| Feature            | Giskard Open Source                                                           | Giskard Hub                                       |
| :----------------- | :---------------------------------------------------------------------------- | :------------------------------------------------ |
| Multi-user access  | [⚠️ Collaborate through Git and CI](/oss/checks/how-to/ci-cd)                 | [✅ Shared team workspace](/hub/ui/access-rights) |
| Access control     | ❌ Not available                                                              | [✅ Role-based access](/hub/ui/access-rights)     |
| Project management | [⚠️ Version tests in your repository](/oss/checks/how-to/ci-cd)               | [✅ Centralized](/hub/ui/access-rights)           |
| Dataset sharing    | [⚠️ Serialize and share suite JSON](/oss/scan/how-to/save-and-version-suites) | [✅ Team-wide](/hub/ui/access-rights)             |
