...
| :------------------------------- | :---------------------- | :------------------------------------------------------------ |
| **Core Testing**                 |                         |                                                               |
| Security vulnerability detection | [Basic coverage](/oss/scan) | [55+ probes, continuously updated](/hub/ui/scan)              |
| Business failure detection       | [Basic coverage](/oss/scan) | [Knowledge-base driven](/hub/ui/datasets/knowledge-base)      |
